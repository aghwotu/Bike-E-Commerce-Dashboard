		...
		<div class="panel add-categ-panel">
			<div class="panel-default ">
				<ul class=" ul-panel-header">
					...
					<li><label class="">Edit Category</label></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="panel-body ">
				<form role="form">
					<div class="form-group">
						...
						<input type="" name="newcateg" class="form-control custom-form-control"
						 id="new-categ" value="<?php echo($categ_name); ?>">
					</div>
					<div class="form-group">
						...
						<input type="button" name="submit-categ" class="btn btn-primary btn-lg save-btn" id="new-categ-btn" value="UPDATE" />
						<!-- NOTE TO SELF -->
